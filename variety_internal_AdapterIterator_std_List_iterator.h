/*
 *  variety_internal_AdapterIterator_std_List_iterator.h
 *  collection
 *
...
namespace variety {
	...
	namespace internal {
		...
		class AdapterIterator<std::_List_iterator<ValueTemplate>, ContainerTemplate > :
		public virtual AdapterIteratorInterface<std::_List_iterator<ValueTemplate>, ContainerTemplate>,
		public virtual InputIteratorInterface<typename std::_List_iterator<ValueTemplate>::reference>,
		public virtual BasicIteratorInterface,
		public virtual ForwardIteratorInterface,
		public virtual BackwardIteratorInterface
		{
		protected:
			typedef std::_List_iterator<ValueTemplate> IteratorTemplate;
		public:

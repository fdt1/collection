/*
 *  lazy4_internal_ModifierWithBooleanXor.h
 *  collection
 *
...
namespace lazy4 {
	...
	namespace internal {
		...
		public:
			...
			virtual output_type getOutput(parameter_input_type input) { return ((bool) _left.getOutput(input)) ^ ((bool) _right.getOutput(input)); }
			
			//! @return the output of a functor
			virtual const_output_type getConstOutput(parameter_input_type input) const { return ((bool) _left.getConstOutput(input)) ^ ((bool) _right.getConstOutput(input)); }

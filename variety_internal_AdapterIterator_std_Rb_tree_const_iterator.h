/*
 *  variety_internal_AdapterIterator_std_Rb_tree_const_iterator.h
 *  collection
 *
...
namespace variety {
	...
	namespace internal {
		...
		class AdapterIterator<std::_Rb_tree_const_iterator<ValueTemplate>, ContainerTemplate > :
		public virtual AdapterIteratorInterface<std::_Rb_tree_const_iterator<ValueTemplate>, ContainerTemplate>,
		public virtual InputIteratorInterface<typename std::_Rb_tree_const_iterator<ValueTemplate>::reference>,
		public virtual BasicIteratorInterface,
		public virtual ForwardIteratorInterface,
		public virtual BackwardIteratorInterface
		{
		protected:
			typedef std::_Rb_tree_const_iterator<ValueTemplate> IteratorTemplate;
		public:

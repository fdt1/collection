/*
 *  variety_internal_AdapterIterator_std_Bit_const_iterator.h
 *  collection
 *
...
namespace variety {
	...
	namespace internal {
		...
		class AdapterIterator<std::_Bit_const_iterator, ContainerTemplate> :
		public virtual AdapterIteratorInterface<std::_Bit_const_iterator, ContainerTemplate>,
		public virtual InputIteratorInterface<typename std::_Bit_const_iterator::reference>,
		...
		{
		protected:
			typedef std::_Bit_const_iterator IteratorTemplate;
		public:
